...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="GPUs per node config for slurm, " "should be set according to your slurm environment",
    )
    parser.add_argument(
        "--cpus_per_task",
        type=int,
        default=5,
        help="CPUs per task config for slurm, " "should be set according to your slurm environment",
    )
    parser.add_argument(
        "--gpus",
        type=int,
